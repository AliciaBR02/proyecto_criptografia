...
# Log in form
Label(window_login, text="Please enter details below to login", bg=background_color).pack()
...
# Sign up form
Label(window_register, text="Please enter details below to register", bg=background_color).pack()
Label(window_register, text="", bg=background_color).pack()
etiqueta_nombre = Label(window_register, bg=background_color, text="Name * ")
etiqueta_nombre.pack()
name_enter = Entry(window_register, textvariable=name)
name_enter.pack()

etiqueta_apellido = Label(window_register, bg=background_color, text="Surname * ")
etiqueta_apellido.pack()
surname_enter = Entry(window_register, textvariable=surname)
surname_enter.pack()

etiqueta_email = Label(window_register, bg=background_color, text="Email * ")
etiqueta_email.pack()
email_enter = Entry(window_register, textvariable=email)
email_enter.pack()

etiqueta_password = Label(window_register, bg=background_color, text="Password * ")
etiqueta_password.pack()
password_enter = Entry(window_register, textvariable=password, show='*')
password_enter.pack()

etiqueta_subjects = Label(window_register, bg=background_color, text="Subject * ")
...
Label(window_student, text="Welcome", bg=background_color).pack()
...
Label(window_teacher, text="Welcome", bg=background_color).pack()
...
Label(window_search, bg=background_color, text="Enter the following information").pack()
...
# Add mark form
Label(window_search, bg=background_color, text="Please enter the mark below").pack()
Label(window_search, bg=background_color, text="").pack()

etiqueta_subjects = Label(window_search, bg=background_color, text="Subject * ")
etiqueta_subjects.pack()
subject_search.pack()

global teacher_search
teacher_search = StringVar()
etiqueta_teacher = Label(window_search, bg=background_color, text="Teacher * ")
etiqueta_teacher.pack()
teacher_enter = Entry(window_search, textvariable=teacher_search)
teacher_enter.pack()
Label(window_search, bg=background_color, text="").pack()

Label(window_search, bg=background_color, text="For security reasons, enter your email and password again, please").pack()
Label(window_search, bg=background_color, text="").pack()

# Enter email and password for security reasons
global email_search
email_search = StringVar()
etiqueta_email_search = Label(window_search, bg=background_color, text="Email * ")
...
etiqueta_password_search = Label(window_search, bg=background_color, text="Password * ")
...
# Add mark form
Label(window_add_mark, bg=background_color, text="Please enter the mark below").pack()
...
email_student_to_mark_exam = Label(window_add_mark, bg=background_color, text="Student * ")
...
etiqueta_exam = Label(window_add_mark, bg=background_color, text="Exam * ")
etiqueta_exam.pack()
exam_enter = Entry(window_add_mark, textvariable=exam)
exam_enter.pack()

etiqueta_mark = Label(window_add_mark, bg=background_color, text="Mark * ")
etiqueta_mark.pack()
mark_enter = Entry(window_add_mark, textvariable=mark)
mark_enter.pack()

Label(window_add_mark, bg=background_color, text="").pack()
Label(window_add_mark, bg=background_color, text="Comfirm identity").pack()

global email_teacher_to_mark
email_teacher_to_mark = StringVar()
etiqueta_email_teacher_to_mark = Label(window_add_mark, bg=background_color, text="Email * ")
...
etiqueta_password_teacher_to_mark = Label(window_add_mark, bg=background_color, text="Password * ")
...
# Add mark form
Label(window_upload_mark, bg=background_color, text="Please enter the mark below").pack()
Label(window_upload_mark, bg=background_color, text="").pack()

etiqueta_subjects = Label(window_upload_mark, bg=background_color, text="Subject * ")
etiqueta_subjects.pack()
subjects_upload.pack()

global email_student_to_upload
email_student_to_upload = StringVar()
email_student_to_upload_exam = Label(window_upload_mark, bg=background_color, text="Student * ")
...
Label(window_upload_mark, bg=background_color, text="").pack()
Label(window_upload_mark, bg=background_color, text="Comfirm identity").pack()

global email_teacher_to_upload
email_teacher_to_upload = StringVar()
etiqueta_email_teacher_to_upload = Label(window_upload_mark, bg=background_color, text="Email * ")
...
etiqueta_password_teacher_to_upload = Label(window_upload_mark, bg=background_color, text="Password * ")
